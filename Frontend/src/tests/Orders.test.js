...
jest.mock('../Components/Orders/OrderTabs', () => (props) => {
...
jest.mock('../Components/Orders/OrderForm', () => () => <div data-testid="order-form" />);
jest.mock('../Components/Orders/OrderTable', () => (props) => (
